...
if choice == "TAHUB DATA":
    ...
    AgGrid(df)
    fig2 = px.scatter(df,x='Profit Rate(Gross Profit/General Expense)',y='Revenue_rate(Revenue/General Expense)',color='Risk Level',size=18,color_discrete_sequence=["red", "orange", "green"])
